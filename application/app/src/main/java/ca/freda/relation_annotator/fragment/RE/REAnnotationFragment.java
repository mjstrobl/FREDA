...
public class REAnnotationFragment extends AnnotationFragment implements View.OnClickListener {
    ...
    public void setUserVisibleHint(boolean visible) {
        ...
        if (visible) {
            ...
            try {
                currentRelationInfo = activity.comHandler.getRelation().getString("info_short");
                currentRelationName = activity.comHandler.getRelation().getString("name");
