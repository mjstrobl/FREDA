...
public class ELAnnotationFragment extends AnnotationFragment implements View.OnClickListener {
    ...
    public void setUserVisibleHint(boolean visible) {
        ...
        if (visible) {
            ...
            try {
                currentDatasetName = activity.comHandler.getElDataset().getString("name");
                relationTextView.setText("Dataset: " + currentDatasetName);
    ...
    public void fillEntityButtonScrollView() {
        ...
        System.out.println("fillEntityButtonScrollView for EL");
